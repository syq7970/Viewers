...
var times = new Map(); // Register the time method

OHIF.log.time = function (givenKey) {
  var key = typeof givenKey === 'undefined' ? 'default' : givenKey;
  times.set(key, new Date().getTime());
}; // Register the timeEnd method


OHIF.log.timeEnd = function (givenKey) {
  var key = typeof givenKey === 'undefined' ? 'default' : givenKey;
  var now = new Date().getTime();
  var last = times.get(key) || now;
  times.delete(key);
