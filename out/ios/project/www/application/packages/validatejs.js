...
var require = meteorInstall({"node_modules":{"meteor":{"validatejs":{"lib":{"validate.js":function(require,exports,module){
...
(function (exports, module, define) {
  ...
  var validate = function (attributes, constraints, options) {
    ...
    for (attr in meteorBabelHelpers.sanitizeForInObject(results)) {
      for (validator in meteorBabelHelpers.sanitizeForInObject(results[attr])) {
  ...
  v.extend(validate, {
    ...
    runValidations: function (attributes, constraints, options) {
      ...
      for (attr in meteorBabelHelpers.sanitizeForInObject(constraints)) {
        ...
        for (validatorName in meteorBabelHelpers.sanitizeForInObject(validators)) {
    ...
    processValidationResults: function (errors, options) {
      ...
      switch (options.format || "grouped") {
        ...
        case "grouped":
          ...
          for (attr in meteorBabelHelpers.sanitizeForInObject(errors)) {
    ...
    isDomElement: function (o) {
      ...
      if ((typeof HTMLElement === "undefined" ? "undefined" : (0, _typeof2.default)(HTMLElement)) === "object") {
        ...
        return o && (0, _typeof2.default)(o) === "object" && o !== null && o.nodeType === 1 && typeof o.nodeName === "string";
      }
    },
    isEmpty: function (value) {
      ...
      if (v.isObject(value)) {
        for (attr in meteorBabelHelpers.sanitizeForInObject(value)) {
          return false;
        }
    ...
    cleanAttributes: function (attributes, whitelist) {
      ...
      function buildObjectWhitelist(whitelist) {
        ...
        for (attr in meteorBabelHelpers.sanitizeForInObject(whitelist)) {
          if (!whitelist[attr]) {
            continue;
          }
      ...
      function cleanRecursive(attributes, whitelist) {
        ...
        for (attribute in meteorBabelHelpers.sanitizeForInObject(attributes)) {
  ...
  validate.validators = {
    ...
    numericality: function (value, options) {
      ...
      for (name in meteorBabelHelpers.sanitizeForInObject(checks)) {
        count = options[name];
    ...
    datetime: v.extend(function (value, options) {
      ...
      value = this.parse(value, options); // 86400000 is the number of seconds in a day, this is used to remove
    ...
    url: function (value, options) {
      ...
      var regex = "^" + // schemes
      "(?:(?:" + schemes.join("|") + "):\\/\\/)" + // credentials
      "(?:\\S+(?::\\S*)?@)?";
      regex += "(?:";
      var hostname = "(?:(?:[a-z\\u00a1-\\uffff0-9]+-?)*[a-z\\u00a1-\\uffff0-9]+)" + "(?:\\.(?:[a-z\\u00a1-\\uffff0-9]+-?)*[a-z\\u00a1-\\uffff0-9]+)*" + "(?:\\.(?:[a-z\\u00a1-\\uffff]{2,})))"; // This ia a special case for the localhost hostname
      ...
      regex += "(?:[1-9]\\d?|1\\d\\d|2[01]\\d|22[0-3])" + "(?:\\.(?:1?\\d{1,2}|2[0-4]\\d|25[0-5])){2}" + "(?:\\.(?:[1-9]\\d?|1\\d\\d|2[0-4]\\d|25[0-4]))" + "|" + hostname + // port number
      "(?::\\d{2,5})?" + // path
      "(?:\\/[^\\s]*)?" + "$";
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                   //
var v;
module.watch(require("./lib/validate.js"), {
...
require("/node_modules/meteor/validatejs/lib/validate.js");
require("/node_modules/meteor/validatejs/load.js");

/* Exports */
Package._define("validatejs", {
  validate: validate
});
